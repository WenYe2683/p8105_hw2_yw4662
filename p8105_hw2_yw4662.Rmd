...
Based on the set difference, **171 ZIP codes don't appear in Zillow's ZORI**. Most of the misses (118) have no mapped neighborhood, which usually means the ZIP is largely non-residential or special-use. A smaller but clear group is special-purpose Manhattan ZIPs for large organizations/PO boxes(e.g., 10020, 10110, 10112). We also see airport ZIPs (11371 for LaGuardia and 11430 for JFK) that have no rental stock. These ZIPs exist in postal geography but don't represent residential markets, so Zillow doesn't publish a rental index for them. 
